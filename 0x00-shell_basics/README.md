Write a script that print the absolute pathname of the current working directory
...
Create a magic file school.mgc thta can be use withthe command file to detect School date files. School data files always contain the string SCHOOL at offset 0
